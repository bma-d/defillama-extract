...
| ---- | ----- | ---- | ---- | -------- | ----- | ------ | ----- |
| 2025-12-08 | 7-1-load-custom-protocols-configuration | 7 | Bug | Med | Amelia | Closed | Fixed: presence validation for `is-ongoing`/`live` added with missing-field fixtures/tests (internal/tvl/custom.go:59-93; internal/tvl/custom_test.go:90-133; testdata/tvl/missing_*.json). |
| 2025-12-08 | 7-6-integrate-tvl-pipeline-into-main-extraction-cycle | 7 | Bug | High | Amelia | Closed | Fixed dry-run to skip tvl-state writes and added regression test (internal/tvl/pipeline.go:105-124; internal/tvl/pipeline_test.go:80-109). |
| 2025-12-08 | 7-6-integrate-tvl-pipeline-into-main-extraction-cycle | 7 | Test Gap | High | Amelia | Closed | Added RunOnce/TVL integration tests for sequencing/isolation/logging/exit codes (cmd/extractor/main_test.go:369-515). |
| 2025-12-08 | 7-6-integrate-tvl-pipeline-into-main-extraction-cycle | 7 | Test Gap | Med | Amelia | Closed | Added rate-limit sequential timing test for FetchAllTVL (internal/tvl/fetcher_test.go:55-83). |
